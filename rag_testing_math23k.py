...
client = InferenceClient(api_key="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")
...
class DenseRetriever(Retriever):
    ...
    def _encode_corpus(self, corpus_path):
        ...
        corpus = load_dataset(corpus_path, split="train")
        all_embeddings = []
...
if __name__ == "__main__":
    ...
    parse.add_argument("--corpus_dir", type=str, default="Gxg/Math23K")
    parse.add_argument("--output_path", type=str, default="Math23k_randomly_8_shots_Qwen3B_v4.jsonl")
    ...
    parse.add_argument("--retriever_device", type=str, default="cuda:1")
    parse.add_argument("--generator_device", type=str, default="cuda:2")
    ...
    train_dataset = load_dataset(args.corpus_dir, split="train")
    val_dataset = load_dataset(args.corpus_dir, split="test")
